...
MainWindow::MainWindow(QWidget* parent)
  ...
  connect(ui->loadButton, &QPushButton::clicked, this, &MainWindow::loadState);
  connect(ui->saveButton, &QPushButton::clicked, this, &MainWindow::saveState);

  connect(ui->selectHandlerPath,
          &QPushButton::clicked,
          this,
          &MainWindow::selectHandlerPath);

  connect(ui->initializeCrashpadButton,
          &QPushButton::clicked,
          this,
          &MainWindow::initializeCrashpad);
...
void MainWindow::initializeCrashpad() {
  ...
  auto handlerPath = ui->handlerPath->text().toStdWString();
  if (backtrace::initialize_crashpad(url, handlerPath)) {
...
void MainWindow::selectHandlerPath() {
  auto f = QFileDialog::getOpenFileName(
      this, "Select handler executable", QDir::current().path());
